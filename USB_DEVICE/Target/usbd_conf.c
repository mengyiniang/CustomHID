...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , CUSTOM_HID_EPOUT_ADDR , PCD_SNG_BUF, 0xE0);
	...
	HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , MOUSR_HID_EPIN_ADDR , PCD_SNG_BUF, 0x120);
	HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData , KEYBOARD_HID_EPIN_ADDR , PCD_SNG_BUF, 0x160);
